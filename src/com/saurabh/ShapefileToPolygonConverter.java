...
public class ShapefileToPolygonConverter {
	...
	public static void main(String[] args) {
		try {
			File shapefile = new File(
					"/home/shatam-100/Down/WaterView_Data/District_Boundary_western/DistrictBoundary.shp");
	...
	public static void convertToPolygon(File shapefile) throws IOException {
		...
		// Add attributes from the original feature type using existing attribute
		// descriptors
