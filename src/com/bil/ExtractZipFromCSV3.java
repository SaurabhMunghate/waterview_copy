...
public class ExtractZipFromCSV3 {
    public static void main(String[] args) throws Exception {
        ...
        Map<String, String> polygonDateMap = new HashMap<>();
        ...
        while ((row = csvReader2.readNext()) != null) {
            ...
            for (Map.Entry<String, String> entry : polygonDateMap.entrySet()) {
