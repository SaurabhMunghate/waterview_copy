...
public class CIMISWeatherStationNetwork_19May {
...
//		Stri
		...
		String thegeoms = "";
//		String landscapedatacsv = "/home/shatam-100/CIMISWeatherStationNetwork/NEW_prd.premise_bounds_jurupa.json";
		String landscapedatacsv = "/home/shatam-100/CIMISWeatherStationNetwork/NEW_prd.premise_bounds_montevista.json";
...
//				U.log("zip " + zip);
				String precipUrl = "https://et.water.ca.gov/api/data?appKey=08807bb2-ce9c-4b65-af3c-dec10f6f3daf&targets="
						+ zip + "&startDate=" + "2010-08-01" + "&endDate=" + "2010-10-01"
...
//						U.log("sumprecip "+sumprecip);
				...
				U.log("Zip : "+zip+" | avgprecip : "+avgprecip);
...
//					System.out.println("Meter "+parts[2]+" | "+parts[0]+parts[1]+" | Distance: " + distance + " km");
					...
					hs.put(distance, "Meter " + parts[2] + " | " + parts[1] + " " + parts[0] + " | " + parts[0] + " " + parts[1]+ " | Distance: "
							+ distance + " km");
...
//						System.out.println();
						newdestLat = destLat;
						newdestLon = destLon;
//						System.out.println("Met " + Met + " | distance " + distance + "  | newdestLatLon" + newdestLon
//								+ " " + newdestLat);
					}
				}System.out.println();
...
//				System.out.println("Three smallest distances:");
				Double avgpreOfThree = 0.0 ;
				Double avgetoOfThree = 0.0 ;
...
//					return;
					try {
						System.out.println("Satation : " + K);
						String cimiSataionUrl = "http://et.water.ca.gov/api/data?appKey=08807bb2-ce9c-4b65-af3c-dec10f6f3daf&targets="
								+ K + "&startDate=2010-08-01&endDate=2010-10-01";
						...
						String precip[] = U.getValues(cimiSataionFile, "day-asce-eto qc=\"", "day");
						String etoValss[] = U.getValues(cimiSataionFile, "day-asce-eto qc=\"", "day");
						String airtmpavg[] = U.getValues(cimiSataionFile, "<day-air-tmp-avg qc=\"", "day");
						String relhumavg[] = U.getValues(cimiSataionFile, "<day-rel-hum-avg qc=\"", "day");
						String soiltmpavg[] = U.getValues(cimiSataionFile, "<day-soil-tmp-avg qc=\"", "day");
						String vappresavg[] = U.getValues(cimiSataionFile, "<day-vap-pres-avg qc=\"", "day");
						try {
							double avgE = 0.0;
							double sumE = 0.0;
							for (String e : airtmpavg) {
								e = U.getSectionValue(e, ">", "<");
								sumE += Double.parseDouble(e);
							}
							avgE = sumE / etoValss.length;
							System.out.println("airtmpavg From Satation ID :" + avgE);
						} catch (Exception e) {
						...
						try {
							double avgE = 0.0;
							double sumE = 0.0;
							for (String e : relhumavg) {
								e = U.getSectionValue(e, ">", "<");
								sumE += Double.parseDouble(e);
							}
							avgE = sumE / etoValss.length;
							System.out.println("relhumavg From Satation ID :" + avgE);
						} catch (Exception e) {
							// TODO: handle exception
						}
						try {
							double avgE = 0.0;
							double sumE = 0.0;
							for (String e : soiltmpavg) {
								e = U.getSectionValue(e, ">", "<");
								sumE += Double.parseDouble(e);
							}
							avgE = sumE / etoValss.length;
							System.out.println("soiltmpavg From Satation ID :" + avgE);
						} catch (Exception e) {
							// TODO: handle exception
						}
						...
						double avgEtoo = 0.0;
						double sumEtoo = 0.0;
						for (String et : vappresavg) {
							et = U.getSectionValue(et, ">", "<");
							sumEtoo += Double.parseDouble(et);
						}
						avgEtoo = sumEtoo / etoValss.length;
						System.out.println("avgEto From Satation ID :" + avgEtoo);
						Double avgprecip = 0.0;
						Double sumprecip = 0.0;
						if (precip.length > 0) {
						...
						System.out.println("avgprecip From Satation ID :" + avgprecip);
//					obj.put("avgprecip From Satation ID :"+K , avgprecip);
//					obj.put("Satation :"+K, K);
//					System.out.println(avgprecip);
					avgpreOfThree += avgprecip;
					avgetoOfThree += avgEtoo;
					} catch (Exception e) {}
//					processStation(K);
				}
				
//				System.out.println("avgPreciOfThree3 ;"+avgpreOfThree/3);
//				System.out.println("avgEtoOfThree3 ;"+avgetoOfThree/3);
				System.out.println("avgEtoOfThree3 ;"+avgetoOfThree);
//				obj.put("avgPreciOfThree :", avgpreOfThree/3);
//				obj.put("avgEtoOfThree :", avgetoOfThree/3);
//				obj.put("avgEtoOfThree :", avgetoOfThree);
				obj.put("premise_bounds lowestdistance", lowestdistance);
//				obj.put("premise_bounds newdestLatLonOFStation", newdestLat + ", " + newdestLon);
//				obj.put("Nearsest Staion Number", Met);
...
//				U.log("AvgEto From this station From Lat Long " + avgEto0);
//				obj.put("avgEtoValueOfStationFromLatLong", avgEto0);
//			} catch (Exception e) {}
...
//		FileUtil.writeAllText("/home/shatam-100/CIMISWeatherStationNetwork/thegeoms.txt", "GEOMETRYCOLLECTION("+thegeoms.toString()+")");

		FileUtil.writeAllText("/home/shatam-100/CIMISWeatherStationNetwork/Eto_montevista.txt", resultArray.toString()); //jsonObj.toString()
	...
	static void processStation(int i) throws Exception {
		...
		String cimiSataionUrl = "http://et.water.ca.gov/api/data?appKey=08807bb2-ce9c-4b65-af3c-dec10f6f3daf&targets="
				+ i + "&startDate=2010-08-01&endDate=2010-10-01";
		U.getData(cimiSataionUrl, U.getCache(cimiSataionUrl));
		String cimiSataionCache = U.getCache(cimiSataionUrl);
		U.log("cimiSataionCache " + cimiSataionCache);
		String cimiSataionFile = FileUtil.readAllText(cimiSataionCache);
		...
		avgEto = sumEto / etoVals.length;
		System.out.println("avgEto From Satation ID :" + avgEto);
		double avgprecip = 0.0;
		double sumprecip = 0.0;
		if (precip.length > 0) {
			for (String pre : precip) {
