...
public class NV5ConsumptionFile {
//	static String consumptionFileName = "/home/chinmay/Downloads/MonteVista_09_13_2022/Consumption/MonteVistaMonthlyNormalized.csv";
//	static String meterDetailsFileName = "/home/chinmay/Downloads/SAWPA-DUMMIE-DATA-SAMPLE/MonteVistaData/MONTEVISTACO226_Meter_Locations.csv";
//	static String landscapedatacsv = "/home/chinmay/Downloads/SAWPA-DUMMIE-DATA-SAMPLE/MonteVistaData/MONTEVISTACO226_Premise_Bounds.csv";
	...
	public static void main(String[] args) {
		new NV5ConsumptionFile().processConsumptionFile(consumptionFileName);
	}
	...
	private void processConsumptionFile(String inpfileName) {
		// TODO Auto-generated method stub
				...
				for (String[] meters : meterData) {
					if(meters[0].contains("the_geom"))continue;
...
//					
					...
					for (Map<?, ?> data : list) {
						...
						try {
							...
							String[] outData= {latlon[1],latlon[0],obj.get("I_SLA").toString(),obj.get("I").toString(),obj.toString()};
				...
				try {
					...
					for (Map<?, ?> data : list) {
				        ...
				        if(meterMap.get(data.get("meter_uid"))==null)continue;
				        DecimalFormat df = new DecimalFormat("####0.00");
				        U.log(Arrays.toString(dataArr));
				        String etoUrl="https://et.water.ca.gov/api/data?appKey=08807bb2-ce9c-4b65-af3c-dec10f6f3daf&targets=lat%3D"+df.format(Double.parseDouble(dataArr[0]))+",lng%3D"+df.format(Double.parseDouble(dataArr[1]))+"&startDate="+sdf.format(fromUser.parse(data.get("reading_date").toString()))+"&endDate="+sdf.format(lastDayOfMonth)+"&dataItems=day-asce-eto&unitOfMeasure=E";
				        //U.log(etoUrl);
				        ...
				        String precipUrl="https://et.water.ca.gov/api/data?appKey=08807bb2-ce9c-4b65-af3c-dec10f6f3daf&targets="+zip.trim()+"&startDate="+sdf.format(fromUser.parse(data.get("reading_date").toString()))+"&endDate="+sdf.format(lastDayOfMonth)+"&dataItems=day-precip&unitOfMeasure=E";
				        U.log(precipUrl);
				       ...
				       // if(allocation< 0)
				      //  	throw new Exception();
				        //(0.62) * { [LACII x 0.8 x (ETo – Peff)] + (1.0 x SLA x ETo) + (LAMWELO x 0.45 x ETo)} + Exempt Water Use Volume
				        //String precip;
